...
SRCS = main.c system_stm32f0xx.c iolib.c serialio.c pwmout.c protos/messages.pb.c i2c.c reprog.c dripper.c hwaccess.c led_override.c interlock.c
...
#	openocd -f $(OPENOCD_BOARD_DIR)/stm32f0discovery.cfg -f $(OPENOCD_PROC_FILE) -c "stm_flash `pwd`/$(PROJ_NAME).bin" -c shutdown
	dfu-util -a 0 --dfuse-address 0x08000000 -D main.bin -d 0483:df11
